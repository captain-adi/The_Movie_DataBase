...
const JoinToday = () => {
  ...
  return (
    <section className="bg-[url('https://media.themoviedb.org/t/p/w1920_and_h800_multi_faces_filter(duotone,190235,ad47dd)/lMnoYqPIAVL0YaLP5YjRy7iwaYv.jpg')]  bg-cover bg-center bg-no-repeat   ">
